...
# Conclusiones
  El modelo mixto o modelo jerárquico demuestra ser una buena alternativa para el entrenamiento del modelo predictivo debido a que presenta un error en entrenamiento del 6% y un error en validación del 5%

  El clustering realizado para el agrupamiento de mapas y el criterio elegido para agruparlos (número de accidentes) demuestran ser bien elegidos debido a que la forma en que se agrupan los datos tiene sentido con la realidad de la ciudad (La Candelaria y Laureles son barrios con mucho flujo vehicular y se encuentran en zonas donde hay mucha afluencia de personas de todo el Valle de Aburrá)
