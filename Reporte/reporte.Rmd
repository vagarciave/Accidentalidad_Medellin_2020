...
Además se crean otras dos variables "SEMANA" y "FECHA_ESPECIAL". Para poder analizar el número de accidentes por semana y en días féstivos y demás fechas especiales. Por lo tanto, las variables de interés que se usan en este proyecto son las siguientes:
...
Para ajustar el modelo se usó la función *train* del paquete *caret*, usando K-Fold CV con $K=10$ y el número de vecinos igual a 1, 4, 7, 10, 13, 16 y 19. Se usó la precisión del modelo como función de optimización. Los resultados obtenidos son los siguientes:
