...
Por lo tanto, las variables de interés que se usan en este proyecto son las siguentes:
...
**Nota:** Depende de lo que responda el profesor, trabajaremos los NA
...
**PELIGRO**, ninguno de estos barrios pertenece al corregimiento san sebastian de palmitas
...
Como solo son 6 NA en esta variable, se decide omitirlos
...
```{r}
write.csv(base_completa, "Base_Completa_NAimp.csv", fileEncoding = "UTF-8",
          row.names = F)
```
